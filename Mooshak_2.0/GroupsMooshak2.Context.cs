...
namespace Mooshak_2._0
{
    ...
    public partial class VLN2_2016_H38Entities4 : DbContext
    {
        public VLN2_2016_H38Entities4()
            : base("name=VLN2_2016_H38Entities4")
        {
        }
        ...
        public virtual ObjectResult<Courses> GetCourses()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Courses>("GetCourses");
        }
    
        public virtual ObjectResult<Courses> GetCourses(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Courses>("GetCourses", mergeOption);
        }
