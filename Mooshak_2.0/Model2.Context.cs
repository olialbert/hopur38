...
namespace Mooshak_2._0
{
    ...
    public partial class VLN2_2016_H38Entities3 : DbContext
    {
        ...
        public virtual ObjectResult<GetPartAssignmentInfoByName_Result> GetPartAssignmentInfoByName(string getName, string desc)
        {
            var getNameParameter = getName != null ?
                new ObjectParameter("GetName", getName) :
                new ObjectParameter("GetName", typeof(string));
        ...
        public virtual ObjectResult<string> GetName(string roleUserName, string rolePassWord)
        {
            var roleUserNameParameter = roleUserName != null ?
                new ObjectParameter("RoleUserName", roleUserName) :
                new ObjectParameter("RoleUserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GetName", roleUserNameParameter, rolePassWordParameter);
        }

        public virtual ObjectResult<Nullable<System.DateTime>> GetAssignmentsDueDate(string getCourseName)
        {
            var getCourseNameParameter = getCourseName != null ?
                new ObjectParameter("GetCourseName", getCourseName) :
                new ObjectParameter("GetCourseName", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.DateTime>>("GetAssignmentsDueDate", getCourseNameParameter);
        }
